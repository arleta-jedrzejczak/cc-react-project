...
export const User=({id})=>{
   ...
   useEffect(() => {
      ...
      axios.get(`https://calm-escarpment-26540.herokuapp.com/users`).then(response=>{         
   ...
   const handleMenuOpen =(e: React.SyntheticEvent)=> setMenuAnchor(e.currentTarget)

   const handleMenuClose = () => setMenuAnchor(null)

   const handleTabChange=(e: React.SyntheticEvent, value: number)=>setTabValue(value)

   const handleAddNewPost=(e: React.SyntheticEvent)=>setOpenNewPost(e.currentTarget)
      ...
      <>
         ...
         <>
            ...
            <Tabs onChange={handleTabChange}>
               <Tab label='Posts' className={classes.tabHeader} style={tabValue===0 ? {color: '#090909'} : {color: '#777'}}/>
               <Tab label='Favourites' className={classes.tabHeader} style={tabValue===1 ? {color: '#090909'} : {color: '#777'}}/>
            </Tabs>
